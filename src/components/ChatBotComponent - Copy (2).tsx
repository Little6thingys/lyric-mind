...
export default function ChatBotComponent({ xml, setXml, regenerateScore }: ChatBotComponentProps) {
 ...
 const regions = ["高亮小节", "1-4 音节", "全部"];
  ...
  <ScrollArea className="flex-1 mb-2">
      ...
      <ScrollArea className="flex-1 mb-2 bg-gray-50 p-4 rounded-lg">
  {messages.map((msg, idx) => (
    <div
      key={idx}
      className={`flex mb-3 ${
...
<button className="bg-blue-500 text-white px-4 py-2 rounded">
 ...
 {/* 聊天历史 */}
        ...
        <div><Button onClick={sendChatMessage} className="text-lg px-6 py-3">发送</Button></div>   
